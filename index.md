...
<!-- Human curation is a widely used feature in platforms like playlists in  and YouTube, book lists in , image boards in <a href="https://www.pinterest.com/">Pinterest</a> and answer collections in <a href="https://www.zhihu.com/">Zhihu</a>. Users can curate items like songs, images, videos and books to form lists that provide a unique perspective into how items can be grouped together. Since correlated items can be explored and consumed together, these item lists directly power user engagement. For example, more than 50% of Spotify users listen to playlists, accounting for more than 1 billion plays per week. We are interested in recommending (<strong>CIKM 2019</strong>) and automatically continuing (<strong>conference submitted</strong>) these user-generated item lists. -->
<!-- <br>
<br> -->
...
<ul>
    ...
    <li>PARADE: A New Dataset for Paraphrase Identification Requiring Computer Science Domain Knowledge
    ...
    <li>ECNU at 2015 CDS track: two re-ranking methods in medical information retrieval. (Working Notes)
